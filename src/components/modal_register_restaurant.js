...
const ModalRegisterRestaurant = props => {
    ...
    return (
        <div className="modal" id="modal_register_restaurant" tabIndex="-1" role="dialog"
                ...
                <div className="modal-content">
                    ...
                    <div className="form-group modal-body">
                        <div className="form-group">
                            <label htmlFor="username" className="form-label text-muted">Nombre Empresa:</label>
                            <input
                                value={store.name}
                                ref={firstRef}
                                type="text"
                        ...
                        <div className="form-group">
                            <label htmlFor="phone" className="form-label text-muted">Telefono:</label>
                            <input
                                value={store.phone}
                                ref={secondRef}
                                type="text"
                            ...
                            local.email !== null ?
                                ...
                                store.phone !== "" ?
                                    ...
                                    <button
                                        ...
                                        data-dismiss="modal"
                                        onClick={() => actions.registerRestaurantPost()}>
                                        Register
                                    </button>
                                    : <button
                                        ref={fifthRef}
